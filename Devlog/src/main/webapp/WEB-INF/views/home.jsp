            ...
            <div id="testimonials-carousel" class="testimonials-carousel carousel slide" data-interval="8000">
                ...
                <div class="carousel-inner">
                    <div class="item carousel-item active">
                        ...
                        구현할 수 있는 '개발'이라는 것이 정말 매력적으로 다가왔습니다. 쉽지는 않지만, 생각을 프로그래밍으로 구현해낼 때 만큼 흥미로운 게 없습니다. 교육원을 수료하고나서도 계속적으로 udemy.com, edwith.org 같은 곳에서 동영상 강의를 들어오며
                       <span style="font-weight:bold;"> JAVA, JavaScript, Oracle, Spring에 대한 이해와 기술을 지속적으로 쌓아왔습니다.<br>
        ...
        <section id="portfolio-section" class="portfolio-section section">
            ...
            <div class="items-wrapper isotope row">
                ...
                <div class="item backend col-lg-3 col-6">
                    <div class="item-inner">
                        <figure class="figure">
                            <img class="img-fluid" src="<c:url value='/resources/assets/images/portfolio/portfolio-2.png'/>"/>
                        </figure>
                        <div class="content text-left">
                            <h3 class="sub-title"><a href="#">포트폴리오 메인</a></h3>
                            <div class="meta">BootStrap</div>
                            <div class="action"><a href="#">현재 보고 있는 사이트입니다.</a></div>
                        </div><!--//content-->    
                ...
                <div class="item backend frontend col-lg-3 col-6">
                    <div class="item-inner">
                        <figure class="figure">
                            <img class="img-fluid" src="<c:url value='/resources/assets/images/portfolio/portfolio-3.png'/>/">
                        </figure>
                        <div class="content text-left">
                            <h3 class="sub-title"><a href="http://develop-kim.com/devlog/" target="_blank">Devlog2</a></h3>
                            <div class="meta">JAVA/BoostStrap</div>
                            <div class="action"><a href="http://develop-kim.com/devlog/" target="_blank">저의 개인블로그 입니다.</a></div>
                        </div><!--//content-->    
                        <a class="link-mask" href="http://develop-kim.com/devlog/" target="_blank"></a>              
                    </div><!--//item-inner-->
                </div><!--//item-->
